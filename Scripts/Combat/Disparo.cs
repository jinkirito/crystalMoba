...
/*Esta es la clase disparo que lo que hace es tener un prefab llamado Bala que es un objeto y un daño especifica del ataque en caso de que hacierte*/ 
public class Disparo : Skill
{
